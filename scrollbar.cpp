...
void Slider::hover(){
    ...
    if( showed == false ){
        ...
        animation->setStartValue(QColor(90, 150, 230, 0));
        animation->setEndValue(QColor(90, 150, 230, 255));
        animation->start();
    }
}
...
void Slider::hoverTimerFinish(){
    ...
    if( last_hide != 0 ){
        ...
        QPropertyAnimation *animation = new QPropertyAnimation(this, "color");
        animation->setDuration(500);
        animation->setStartValue(QColor(90, 150, 230, 255));
        animation->setEndValue(QColor(90, 150, 230, 0));
        animation->start();
        showed = false;
    }
}
